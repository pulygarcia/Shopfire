...
<template>
  <li class="flex items-center space-x-6 bg-white shadow-lg p-6">
    ...
    <div>
      ...
      <button @click="deleteHandler(product.id)">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mt-2 text-red-500">
